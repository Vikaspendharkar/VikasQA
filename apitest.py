...
pstapi = requests.post('https://test.omniparcel.com/ratesqueryv1/availablerates',
headers={"Content-Type" : "application/json", "access_key" : "64CC20092A075F942111A211912EC060D393980114BD499695"},
   		json={
      "Origin":{
      "Name":"Omni Test",
